...
export default class LayerTest extends Component {
  constructor(props) {
    super(props);
    this.state = {
      date: new Date(),
  ...
  render() {
    return (
      <div>
        ...
        <Stage id="stage" height="800" width="800">
          <Layer className="layer">
            <Circle x={400} y={400} radius={80} fill={'#187d91'} />
          </Layer>
          <Layer className="layer">
            <Circle x={100} y={100} radius={40} fill={'#d1d1d1'} />
          </Layer>
          </Stage>
      </div>
    );
